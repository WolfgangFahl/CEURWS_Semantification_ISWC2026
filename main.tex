...
\title{Semantify CEUR-WS}

\author{Wolfgang Fahl\inst{1}\orcidID{0000-0002-0821-6995} \and
Tim Holzheim\inst{1}\orcidID{0000-0003-2533-6363} \and
Christoph Lange\inst{1,2}\orcidID{0000-0001-9879-3827} \and
Stefan Decker\inst{1,2}\orcidID{0000-0001-6324-7164} \and
Jerven Bolleman\inst{3}\orcidID{0000-0002-7449-1266}}
...
In this work we show how the semantification is in progress and wikidata has been used as the core infrastructure to overcome the obstacles that the change in workflow has ben struggling with since the 2015 Sempub challenge.
