...
In the workflow the existing entries will later be reusable for computer assisted lookups as
part of the SemPubFlow tool see section \ref{sec:sempubflow_tool} and Scholia.
