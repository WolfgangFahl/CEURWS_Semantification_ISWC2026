...
%
% Based on prior SWJ submission (IOS Press template -- to be migrated to LNCS, see issue #2)
...
%% Article Info
%\firstpage{1}  % IOS Press specific -- remove after LNCS migration
%\lastpage{4}   % IOS Press specific -- remove after LNCS migration
%\volume{1}     % IOS Press specific -- remove after LNCS migration
%\pubyear{0000} % IOS Press specific -- remove after LNCS migration
...
% SWJ open review blocks removed -- not applicable for ISWC
%\begin{review}{editor}
